deepspeed --include=localhost:0,1,2,3,4,5,6,7 --master_port 50123 train_re.py --cuda  --data scrc --deepspeed_config config_scrc.json \
    ...
    --inp 'mi' --couple-label False --imagesize 256 --batchsize 32 \
